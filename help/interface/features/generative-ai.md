...
|------------------|-------------------------|------------------|---------------------------|
| [Adobe GenStudio for Performance Marketing](#gspm) |  GenStudio for Performane Marketing is a genAI application. It helps marketing and creative teams create personalized, on-brand content. | Not applicable | Yes |
| [Adobe Experience Manager Sites](#aem) |  GenAI is used in [Generate Variations](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) to create content variations based on input. | Not applicable | Yes |
| [Sites Optimizer](#aem) |  GenAI helps you analyze and improve the performance and effectiveness of web experiences. | Not applicable | No |
...
| [Adobe Journey Optimizer](#journey-optimizer) | Not applicable  |  Available for product knowledge and operational insights. | No |
...
| [[!DNL Adobe Journey Optimizer] B2B Edition](#ajo-b2b) | Not applicable | Available to help with product knowledge. | No |
| [[!DNL Campaign] Managed Cloud Services](#campaign-cs) | Not applicable | Available for Content Accelerator to auto-generate personalized, engaging, and effective content based on marketing objectives across channels like Email, SMS, and Push | Yes |
...
| [[!DNL Real-Time CDP]](#rtcdp) | Not applicable | Available for product knowledge from Experience League. It also offers operational insights (in beta).| No |
...
| [[!DNL Workfront]](#workfront) | GenAI is used with [in-app](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en) information and suggestions. | Not applicable | Yes |
