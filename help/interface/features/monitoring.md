...
> [!IMPORTANT]
>
> Monitoring data is available only in the default production sandbox. Development sandboxes are not supported for viewing monitoring data.
>
> Users must have the required Monitoring permissions for the default production sandbox and switch to that sandbox to view monitoring data.
>
