...
* The Adobe Experience Platform product card in the Admin Console includes:
  ...
  * Visitor ID
   ...
   For organizations that are not currently using Experience Platform, you will now see the _Adobe Experience Platform_ product in the [!DNL Admin Console], including the capabilities listed above.
...
See [Identity types on Adobe [!DNL Admin Console]](https://helpx.adobe.com/enterprise/using/identity.html) for information on identity types.
...
* During the migration, Experience Cloud application may be inaccessible for approximately 15 minutes and [!DNL Admin Console] may be inaccessible up to 30 minutes. Otherwise, this migration will be seamless.

### Changes after the migration

[!DNL Admin Console]

* Administrators with multiple accounts may see a profile selector when signing into [!DNL Admin Console].
* Individual Adobe ID users are updated to Business ID.
* The Business ID directory are added in **[!UICONTROL Settings]** > **[!UICONTROL Identity]** > **[!UICONTROL Directories]**.
...
* [Manage users](https://helpx.adobe.com/enterprise/using/users.html) in [!DNL Admin Console]
* [Manage products and profiles](https://helpx.adobe.com/enterprise/using/manage-products.html) in [!DNL Admin Console].
...
In [!DNL Admin Console], you can delegate limited administrative rights to others in your organization. Delegated roles enable users to administer software access to end users, provide access deployment capabilities, and function as support delegates.
...
1. In the [!DNL Admin Console], select **[!UICONTROL Users]**, then select the user's name.

    ![Administrative Rights in [!DNL Admin Console]](assets/edit-admin-rights.png)

1. Select **[!UICONTROL Edit admin rights]**.

    ![Edit administrative rights in [!DNL Admin Console]](assets/edit-admin-rights-page.png)
...
|Analytics Tools|Enable user permissions for General items (billing, logs, and so on), Company Management, Tools, Web Service Access, Report Builder, and Data Connectors integration. Company settings from the Customize [!DNL Admin Console] category have been moved to Analytics Tools.|

**User Account Migration**

An Analytics user ID migration tool is available to help Analytics administrators migrate user accounts from Analytics User Management to the [Adobe [!DNL Admin Console]](https://adminconsole.adobe.com/enterprise/).

The account migration is being rolled out to customers in phases. Adobe will notify and assist you when it is your time to migrate existing user accounts from **[!UICONTROL Admin Tools]** > **[!UICONTROL User Management]** to the [!DNL Admin Console].
...
See [User permissions](https://experienceleague.adobe.com/docs/experience-platform/tags/admin/user-permissions.html?lang=en) for information about user permissions in the [!DNL Admin Console] and about setting up rights to profiles.

## Experience Manager as a Cloud Service

Adobe Enterprise customers are represented as Organizations in the Adobe [!DNL Admin Console]. Experience Manager customers can use the Adobe [!DNL Admin Console] to manage product entitlements and IMS authentication to Experience Manager as a [!UICONTROL Cloud Service].
