...
| **`s_ecid`** | 63115200 (2 years) | ~45 bytes | Contains a copy of the CX Enterprise ID (ECID/MID) in the format `s_ecid=MCMID\|<ECID>`. Acts as a first-party backup of the ECID, primarily for CNAME (first-party) scenarios. |
