...
---
# Adobe Experience Cloud IP addresses
...
The following table covers all Adobe-owned IP addresses. The table includes all Adobe employee offices and data centers run by Adobe. It does not include services hosted on public clouds.
...
Products and services in the Adobe Experience Cloud that collect data use Amazon Web Services. The following table includes AWS IPv4 host addresses reserved for Adobe. These hosts are **not** included in the aggregate block range above.
