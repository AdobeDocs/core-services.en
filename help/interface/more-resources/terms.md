...
| **Visitor ID Service / ECID** | The persistent visitor identifier used across solutions; often deployed with tags or Web SDK. Commonly referenced as **MID** in older Analytics discussions. See the [Visitor ID Service overview](https://experienceleague.adobe.com/docs/id-service/using/home.html). | Distinct from a single app's legacy cookie name or from **Experience Platform Identity Service** concepts, though they can relate in an implementation. |
