...
|**[!UICONTROL Experience Cloud ID Service] (ECID)**|No special use.|The unique, persistent ID assigned to a site visitor. It is a specific entity that can be used by the Experience Platform Identity Service. [More...](https://experienceleague.adobe.com/docs/id-service/using/home.html)|
...
|**Linking**|No special use. Linking refers to hyperlink navigation, and linking items like fonts, properties, layers, and so on.|In Experience Cloud, linking usually refers to linking different application accounts to the interface.<br>See [Organizations and account linking](../administration/organizations.md).<br>Linking also refers to standard URLs for Analytics reports sent to other users.|
