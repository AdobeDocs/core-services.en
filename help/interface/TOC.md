...
+ Interface services {#services}
  ...
  + Assets {#assets}
    ...
    + [Share asset folders](services/assets/share.md)
  ...
  + Customer Attributes {#customer-attributes}
    ...
    + [Create and upload data](services/customer-attributes/t-crs-usecase.md)
...
+ Administration {#administration}
  + [User and product management](administration/admin-console.md)
