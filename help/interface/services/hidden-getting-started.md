...
hidefromtoc: yes
---
# Get started with CX Enterprise services

If you recently implemented CX Enterprise using Experience Platform tags, you're already set up for Customer Attributes and CX Enterprise Audiences. You can also manage users and products in the Admin Console.
...
## Join the CX Enterprise and become an administrator {#section_2423F0BD3DF642658103310EE5EA6154}

What you must do to join CX Enterprise: 
...
The **[!UICONTROL Admin Console]** link is available in CX Enterprise menu navigation.
...
See [Link accounts in CX Enterprise](../administration/organizations.md)
...
## Implement the [!UICONTROL CX Enterprise ID Service] {#section_3C9F6DF37C654D939625BB4D485E4354}
...
For complete CX Enterprise ID Service help (formerly, visitor ID), go [here](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html#intro).
...
## Map report suites to a CX Enterprise Organization {#section_7B08516B01BA421681DF03D0E86CE3BA}
