...
This documentation applies to features of the unified header in CX Enterprise, such as the [!DNL People] service ([!DNL Audience Library] and [!DNL Customer Attributes]), user and product management for CX Enterprise, cookies, account preferences, notifications, and so on. 

To access these services in CX Enterprise, select the **[!UICONTROL Application Selector]**
...
|[Assets](assets/experience-cloud-assets.md)|CX Enterprise Assets provide a single, centralized repository of marketing-ready assets that you can share across applications.|
