...
Click the application selector ![menu](assets/menu-icon.png) to access CX Enterprise services that you own.
...
![Search and support in CX Enterprise](assets/search-menu.png) 
...
![Manage CX Enterprise](assets/preferences-page.png)
